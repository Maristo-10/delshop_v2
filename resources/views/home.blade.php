...
<head>
    ...
    <link rel="stylesheet" href="pembeli/fonts/icomoon/style.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css" crossorigin="anonymous">


    <link rel="stylesheet" href="pembeli/css/bootstrap.min.css">
    <link rel="stylesheet" href="pembeli/css/magnific-popup.css">
    <link rel="stylesheet" href="pembeli/css/jquery-ui.css">
    <link rel="stylesheet" href="pembeli/css/owl.carousel.min.css">
    <link rel="stylesheet" href="pembeli/css/owl.theme.default.min.css">


    <link rel="stylesheet" href="pembeli/css/aos.css">

    <link rel="stylesheet" href="pembeli/css/style.css">
...
<body>
    ...
    <script src="pembeli/js/jquery-3.3.1.min.js"></script>
    <script src="pembeli/js/jquery-ui.js"></script>
    <script src="pembeli/js/popper.min.js"></script>
    <script src="pembeli/js/bootstrap.min.js"></script>
    <script src="pembeli/js/owl.carousel.min.js"></script>
    <script src="pembeli/js/jquery.magnific-popup.min.js"></script>
    <script src="pembeli/js/aos.js"></script>

    <script src="pembeli/js/main.js"></script>
