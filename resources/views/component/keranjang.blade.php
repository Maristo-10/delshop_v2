...
<div class="site-section">
    <div class="container pl-5" style="max-width: 1300px">
        <div class="row mb-5">
                ...
                <div class="col-lg-12 mb-4" style="border: solid 1px; border-radius: 5px">
                    <div class="row p-4">
                        <div class="col-lg-1" style="place-self: center">
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" class="custom-control-input text-white" id="check2">
            ...
            <div class="col-lg-4 ml-3" style="border:solid 1px; border-radius: 5px;max-height:200px; min-height:200px">
                <div class="row pt-4 ml-1">
                    ...
                    <div class="col-lg-12 pt-2" style="text-align-last:center">
                        <p><a href="/checkout" class="buy-now btn btn-sm btn-primary">Lanjutkan Pemesanan</a></p>
                    </div>
                </div>
            </div>
        </div>
