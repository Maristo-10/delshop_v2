                    ...
                    <tbody>
                        ...
                        @foreach ($pesanan as $pes)
                            <tr>
                                ...
                                <td>{{ $pes->name }}</td>
                                <td>{{ $pes->alasan }}</td>
                                <td style="text-align: center"><span class="badge badge-lg bg-danger text-white"
                                ...
                                <td><button class="btn btn-sm dropdown-toggle more-horizontal" type="button"
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        <button class="dropdown-item" href="#" data-toggle="modal"
                                            data-target=".modal-detail-{{ $pes->kode }}">Detail Pesanan</button>
                                    </div>
                                </td>
                            </tr>
                                        ...
                                        <div class="modal-body p-4">
                                            <div class="row">
                                                <div class="col-lg-12 pt-3 pb-2" style="text-align: -webkit-right">
                                                    <div class="col-lg-4">
                                                        <h4><span class="badge badge-lg bg-danger text-white"
                                                ...
                                                <div class="col-lg-12 pt-3">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-12"><small>{{$pes->alasan}}</small></h5>
                                                        </div>
                                                    </div>
                                                </div>
                                                @php
                                                ...
                                                <div class="col-lg-12 pt-4">
                                                    <div class="row">
                                                        <div class="col-12">
                                                            ...
                                                            <div class="col-lg-12" style="overflow-y: auto; max-height: 230px;">
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-lg-2"
                                                                                ...
                                                                                <img src="/product-images/{{ $det->gambar_produk }}"
                                                                                    alt="" class="w-100 img-fluid" style="max-height: 100px; max-width: 100px">
                                                                            </div>
                                                                            <div class="col-lg-8">
                                                                                <div class="row">
                                                                                    <div class="col-lg-12">
                                                                                        <div class="row">
                                                                                            <div class="col-lg-6">
                                                                                                <small style="font-weight: bold">Nama
                                                                                                    Produk</small></div>
                                                                                            <div class="col-lg-5">
                                                                                    ...
                                                                                    <div class="col-lg-12">
                                                                                        <div class="row">
                                                                                            <div class="col-lg-6">
                                                                                                <small style="font-weight: bold">Jumlah
                                                                                                    Produk</small></div>
                                                                                            <div class="col-lg-5">
                                                                                    ...
                                                                                    <div class="col-lg-12">
                                                                                        <div class="row">
                                                                                            <div class="col-lg-6">
                                                                                                <small style="font-weight: bold">Subtotal
                                                                                                    Harga</small></div>
                                                                                            <div class="col-lg-5">
                                                                                                <small>Rp.
                                                                                                    <?php
