                                ...
                                <td><button class="btn btn-sm dropdown-toggle more-horizontal" type="button"
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        ...
                                        <a class="dropdown-item"
                                            href="/proses/ubah/status/produk/{{ $data->id_produk }}">
                                            @if ($data->status_produk == 'Aktif')
                                                Non-Aktifkan
                                            @else
                                                Aktifkan
                                        ...
                                        <button class="dropdown-item" href="#" data-toggle="modal"
                                            data-target=".modal-detail-{{ $data->id_produk }}">Detail</button>
                                    </div>
                                </td>
                            </tr>
                            <div class="modal fade modal-detail-{{ $data->id_produk }} modal-slide" tabindex="-1"
